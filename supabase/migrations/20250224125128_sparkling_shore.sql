/*
  # Populate Programs and Projects Tables

  1. New Data
    - Adds initial program entries with descriptions and components
    - Adds initial project entries with descriptions and statuses

  2. Changes
    - Populates programs table with 5 main programs
    - Populates projects table with 5 initial projects
